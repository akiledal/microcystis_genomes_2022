...
#arguments <- docopt(doc, args = c("--gtdb=/geomicro/data2/kiledal/references/kraken_databases/refseq/inspect_w_lineage.txt",
#                                 "--refseq=/geomicro/data2/kiledal/references/kraken_databases/gtdb_r202/inspect_w_lineage.txt",
